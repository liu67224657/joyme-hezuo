...
class ActiveQmqjUsersModel extends JoymeModel
{
    public $fields = array();

    public $tableName = 'active_qmqj_users';
    ...
    public function updateUserVoteNum( $user_id ){
        ...
        return $this->excuteSql('update active_qmqj_users set vote_num = vote_num+1 WHERE id = '.$user_id);
    }
